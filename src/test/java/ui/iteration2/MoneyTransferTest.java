...
//
//        var allTransactionUser1FromApi = ApiWait.untilNotEmpty(()->user1.getTransaction(account1.getId()));
//        var allTransactionUser2FromApi =  ApiWait.untilNotEmpty(()->user2.getTransaction(account2.getId()));
//
